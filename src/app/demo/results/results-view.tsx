    ...
    <main className={styles.page} ref={containerRef}>
      ...
      <div className={styles.compareGrid}>
        <div className={`${styles.compareCell} ${isYou ? styles.compareCellYou : ""}`}>
          ...
          <canvas className={styles.playCanvas} id="cmp-you" width="380" height="304" />
        ...
        <div className={`${styles.compareCell} ${styles.compareCellModel}`}>
          ...
          <canvas className={styles.playCanvas} id="cmp-model" width="380" height="304" />
        ...
        <div className={`${styles.compareCell} ${styles.compareCellFrontier}`}>
          ...
          <canvas className={styles.playCanvas} id="cmp-frontier" width="380" height="304" />
