  ...
  return (
    <>
      <main className="flex min-h-screen flex-col items-center justify-center bg-black px-6 text-white">
        ...
        <p className="mb-3 max-w-md text-center font-mono text-sm text-white/60">
        ...
        <p className="mb-10 max-w-md text-center font-mono text-xs text-white/40">
          This demo is meant for a desktop browser.
        </p>
